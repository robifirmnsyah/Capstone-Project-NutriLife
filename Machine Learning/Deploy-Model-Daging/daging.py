...
# Import model
model = keras.models.load_model("model_daging.h5")
modelrekom = keras.models.load_model("rekomendasi_daging.h5")


def load_recipe_data():
    recipe_data = []
    with open('Resep - Daging.csv', 'r') as csvfile:
...
def index():
    if request.method == "POST":
        ...
        try:
            class_names = ["Cumi-cumi", "Daging Sapi", "Daging Unggas", "Gurita", "Ikan", "Jeroan",
                           "Lobster", "Kerang", "Kikil", "Kepiting", "Udang", "Usus"]
            ...
            # Membaca info gizi
            df = pd.read_csv("Informasi Gizi Daging.csv", sep=',')
