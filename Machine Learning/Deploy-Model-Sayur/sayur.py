...
# Import model
model = keras.models.load_model("model_sayuran.h5")
modelrekom = keras.models.load_model("rekomendasi_sayuran.h5")


def load_recipe_data():
    recipe_data = []
    with open('Resep - Sayur.csv', 'r') as csvfile:
...
def index():
    if request.method == "POST":
        ...
        try:
            class_names = ["Bayam Hijau", "Brokoli", "Buncis", "Jamur", "Jengkol", "Kangkung", "Kembang Kol",
                           "Kol", "Labu Siam", "Petai", "Sawi", "Selada", "Tauge", "Terong", "Timun", "Wortel"]
            ...
            # Membaca info gizi
            df = pd.read_csv("Informasi Gizi Sayuran.csv", sep=',')
