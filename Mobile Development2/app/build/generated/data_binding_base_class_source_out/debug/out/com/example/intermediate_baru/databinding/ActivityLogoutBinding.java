...
public final class ActivityLogoutBinding implements ViewBinding {
  ...
  private ActivityLogoutBinding(@NonNull ConstraintLayout rootView, @NonNull Button ButtonLogout) {
  ...
  public static ActivityLogoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLogoutBinding((ConstraintLayout) rootView, ButtonLogout);
    }
